...
| Career profile | `~/Obsidian Vault/Vladimir's Vault/20 Goals/Career/Career Profile.md` | Vladimir | Append-mostly | `/leto`, `/blake`, `/product-ops` when career-adjacent |
...
| Session logs | `~/Obsidian Vault/Vladimir's Vault/80 System/Sessions/YYYY/YYYY-MM-DD-<slug>.md` | `/leto` | Append-only, never edited | `/leto` at next session start |
