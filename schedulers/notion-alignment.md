...
6. ~/.claude/projects/-Users-vladimir-mashkovtsev-Projects-Leto/memory/feedback_function_backlog_style.md (binding for any Function Backlog property proposals)
7. ~/.claude/projects/-Users-vladimir-mashkovtsev-Projects-Leto/memory/project_it_benefit.md and project_capitalisation.md (so the 3 distinct workstreams aren't re-merged)
