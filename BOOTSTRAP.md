...
4. `~/.claude/projects/-Users-vladimir-mashkovtsev-Projects-Leto/memory/MEMORY.md` — index.
5. Every `~/.claude/projects/-Users-vladimir-mashkovtsev-Projects-Leto/memory/user_*.md` — who Vladimir is.
6. Every `~/.claude/projects/-Users-vladimir-mashkovtsev-Projects-Leto/memory/feedback_*.md` — what he's learned about himself and his environment.
7. Every `~/.claude/projects/-Users-vladimir-mashkovtsev-Projects-Leto/memory/project_*.md` — active projects.
