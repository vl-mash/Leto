...
3. **Update memory if patterns emerged**: when Vladimir tells you something that's a durable preference or political fact, write it to `~/.claude/projects/-Users-vladimir-mashkovtsev/memory/<appropriate-file>.md` and update MEMORY.md.
